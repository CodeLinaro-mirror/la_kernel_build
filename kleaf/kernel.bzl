...
load("//build/kernel/kleaf/impl:ddk/ddk_prebuilt_module.bzl", _ddk_prebuilt_module = "ddk_prebuilt_module")
...
load("//build/kernel/kleaf/impl:kernel_config_devicetree_library.bzl", _kernel_config_devicetree_library = "kernel_config_devicetree_library")
...
ddk_prebuilt_module = _ddk_prebuilt_module
...
kernel_config_devicetree_library = _kernel_config_devicetree_library
